...
export function ApprovalCard(props: ApprovalCardProps): JSX.Element {
  ...
  return (
    <div className="rounded-md border border-border bg-surface p-3 shadow-lg space-y-2">
      ...
      <div className="flex gap-2 pt-1">
        <button
          ...
          className="flex-1 rounded-md border border-border bg-bg text-text py-2 text-sm font-medium"
        >
          Deny
        </button>
        <button
