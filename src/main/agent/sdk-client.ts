...
const SYSTEM_PROMPT = [
  ...
  '   Combine signals: e.g., "type into the browser" → `kdotool search --name firefox` + `kdotool windowactivate <id>` to focus it, then `type(...)` (no click needed because focus is now correct).',
